...
func (service *TestServiceToldataClient) GetTestA(ctx context.Context, req *TestARequest) (*TestAResponse, error) {
	functionName := "cdl.toldata/TestService/GetTestA"
...
func (service *TestServiceToldataClient) GetTestAB(ctx context.Context, req *TestARequest) (*TestAResponse, error) {
	functionName := "cdl.toldata/TestService/GetTestAB"
...
func (client *TestServiceToldataClient_FeedData) Send(req *FeedDataRequest) error {
	functionName := "cdl.toldata/TestService/FeedData_Send_" + client.ID
	if req == nil {
...
func (client *TestServiceToldataClient_FeedData) Done() (*FeedDataResponse, error) {
	functionName := "cdl.toldata/TestService/FeedData_Done_" + client.ID
...
func (impl *TestService_FeedDataToldataServerImpl) Subscribe(service *TestServiceToldataServer, id string) error {
	...
	sub, err = bus.Connection.QueueSubscribe("cdl.toldata/TestService/FeedData_Send_"+id, "cdl.toldata/TestService", func(m *nats.Msg) {
	...
	sub, err = bus.Connection.QueueSubscribe("cdl.toldata/TestService/FeedData_Done_"+id, "cdl.toldata/TestService", func(m *nats.Msg) {
...
func (client *TestServiceToldataClient_StreamData) Receive() (*StreamDataResponse, error) {
	functionName := "cdl.toldata/TestService/StreamData_Receive_" + client.ID
...
func (client *TestServiceToldataClient_StreamData) Done() (*StreamDataResponse, error) {
	functionName := "cdl.toldata/TestService/StreamData_Done_" + client.ID
...
func (impl *TestService_StreamDataToldataServerImpl) Subscribe(service *TestServiceToldataServer, id string) error {
	...
	sub, err = bus.Connection.QueueSubscribe("cdl.toldata/TestService/StreamData_Receive_"+id, "cdl.toldata/TestService", func(m *nats.Msg) {
...
func (service *TestServiceToldataClient) StreamData(ctx context.Context, req *StreamDataRequest) (*TestServiceToldataClient_StreamData, error) {
	functionName := "cdl.toldata/TestService/StreamData"
	if req == nil {
		return nil, errors.New("empty-request")
	}
	reqRaw, err := proto.Marshal(req)	
...
func (client *TestServiceToldataClient_StreamDataAlt1) Receive() (*StreamDataResponse, error) {
	functionName := "cdl.toldata/TestService/StreamDataAlt1_Receive_" + client.ID
...
func (client *TestServiceToldataClient_StreamDataAlt1) Done() (*StreamDataResponse, error) {
	functionName := "cdl.toldata/TestService/StreamDataAlt1_Done_" + client.ID
...
func (impl *TestService_StreamDataAlt1ToldataServerImpl) Subscribe(service *TestServiceToldataServer, id string) error {
	...
	sub, err = bus.Connection.QueueSubscribe("cdl.toldata/TestService/StreamDataAlt1_Receive_"+id, "cdl.toldata/TestService", func(m *nats.Msg) {
		var input StreamDataRequest
		err := proto.Unmarshal(m.Data, &input)
		if err != nil {
			bus.HandleError(m.Reply, err)
...
func (service *TestServiceToldataServer) SubscribeTestService() (<-chan struct{}, error) {
	...
	sub, err = bus.Connection.QueueSubscribe("cdl.toldata/TestService/GetTestA", "cdl.toldata/TestService", func(m *nats.Msg) {
	...
	sub, err = bus.Connection.QueueSubscribe("cdl.toldata/TestService/GetTestAB", "cdl.toldata/TestService", func(m *nats.Msg) {
		var input TestARequest
		err := proto.Unmarshal(m.Data, &input)
		if err != nil {
			bus.HandleError(m.Reply, err)
	...
	sub, err = bus.Connection.QueueSubscribe("cdl.toldata/TestService/FeedData", "cdl.toldata/TestService", func(m *nats.Msg) {
	...
	sub, err = bus.Connection.QueueSubscribe("cdl.toldata/TestService/StreamData", "cdl.toldata/TestService", func(m *nats.Msg) {
	...
	sub, err = bus.Connection.QueueSubscribe("cdl.toldata/TestService/StreamDataAlt1", "cdl.toldata/TestService", func(m *nats.Msg) {
